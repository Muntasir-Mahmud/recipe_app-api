import tempfile  # this create dummy files
import os
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        tag2 = sample_tag(user=self.user, name='Starter')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='Mac n cheese')
...
class RecipeImageUploadsTests(TestCase):
    ...
    def tearDown(self):
        # this functioin will call as the last function
        # of the class
